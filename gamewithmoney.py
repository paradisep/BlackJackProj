...
#Prompts Player to bet money
Betting = True
print("You have $" + str(PlayerMoney))
while Betting == True:
    betamount = int(input("How much would you like to bet?"))
    #Checks if Player can bet enough
    if betamount > PlayerMoney:
        print("You do not have enough to bet $" + str(betamount))
    else:
        Betting = False
PlayerMoney -= betamount
print("You have bet $" + str(betamount) + ". You now have $" + str(PlayerMoney))
...
#Also prints Player's money status
if PlayerBusted==False and DealerBusted==False:
    ...
    if TotalDealerVal>TotalPlayerVal:
        ...
        PlayerMoney += betamount
        print("You gained back $" + str(betamount) + ". You have $" + str(PlayerMoney))
    elif TotalPlayerVal>TotalDealerVal:
        print(f"You win with a {TotalPlayerVal}, Congratulations!")
        PlayerMoney += betamount * 2
        print("You gained $" + str(betamount * 2) + ". You have $" + str(PlayerMoney))
